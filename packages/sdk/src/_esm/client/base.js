...
import { InvalidConfigError, InvalidPaymasterError, MissingPublicClientError, MissingWalletClientError, } from '../errors.js';
...
export class BaseClientMixin extends BaseTransactions {
    async _pollForSendCallsStatus({ txId, retryCount = 6, retryDelay = ({ count }) => Math.min(2000, ~~(1 << count) * 200), // exponential backoff
