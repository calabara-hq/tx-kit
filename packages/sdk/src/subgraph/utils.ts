...
export const formatGqlTransportLayer = (transportLayer: GqlTransportLayer): ITransportLayer => {
    ...
    const formatted: ITransportLayer = {}
...
export const formatGqlDynamicLogic = (dynamicLogic: GqlDynamicLogic): IDynamicLogic => {
    return {
        id: dynamicLogic.id,
        ...
        interactionPowerTypes: dynamicLogic.interactionPowerTypes as InteractionPowerTypes[],
        interactionPowers: dynamicLogic.interactionPowers
    }
}


export const formatGqlLogicConfig = (logicConfig: GqlLogicConfig): ILogicConfig | undefined => {
...
export const formatGqlCustomFees = (fees: GqlCustomFees): ICustomFees => {
    return {
        id: fees.id,
...
export const formatGqlFeeConfig = (feeConfig: GqlFeeConfig): IFeeConfig | undefined => {
...
export const formatGqlTokenMetadata = (metadata: GqlTokenMetadata): ITokenMetadata | null => {
    if (metadata) return metadata;
    return null;
}

export const formatGqlTokens = (tokens: GqlToken[]): IToken[] => {
...
export const formatGqlChannel = (channel: GqlChannel): IChannel => {

    const formatted: IChannel = {
